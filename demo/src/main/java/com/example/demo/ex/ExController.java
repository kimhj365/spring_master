...
public class ExController {
	...
	@RequestMapping("/ex5") // 커맨드 객체 없이 파라미터 받음 localhost"8081/ex4?username=xxx&age=30
	public String ex5(String username, @RequestParam(name="userage", required = false, defaultValue = "10") Integer age ) {
